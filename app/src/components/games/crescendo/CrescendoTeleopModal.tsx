...
export interface CrescendoTeleopModalProps {
    ...
    timeline: Map<number, CrescendoActionType>;
    setTimeline: Setter<Map<number, CrescendoActionType>>;
    isActive: boolean;
...
export function CrescendoTeleopModal({
    ...
    const InputButton = ({ action, color = colors.primary }: { action: CrescendoActionType; color?: string }) => {
        return (
            <Pressable
                style={[
                    s.button,
            ...
            >
                ...
                <Text style={s.button_count}>{linkItemMap[CrescendoActions[action].link_name]?.value}</Text>
            </Pressable>
        );
    };
            ...
            >
                ...
                <Pressable
                    onPress={() => {
                        ...
                        setArrayData((prevArrayData) => {
                            const linkItem =
                                linkItemMap[CrescendoActions[timeline.get(lastTime) as CrescendoActionType].link_name];
                            if (linkItem) {
                                const { index } = linkItem;
                                const newArrayData = [...prevArrayData];
                                newArrayData[index] = prevArrayData[index] - 1;
                ...
                >
                    ...
                    >
                        ...
                        <InputButton action={CrescendoActionType.MissSpeaker} color={"red"} />
