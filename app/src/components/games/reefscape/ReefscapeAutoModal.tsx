        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        {linkItemMap[ReefscapeActions[negativeAction].link_name]?.value ?? 0}
                    </Text>
                </View>
            </Pressable>
            <Pressable
            ...
            >
                ...
                >
                    ...
                    >
                        {linkItemMap[ReefscapeActions[positiveAction].link_name]?.value ?? 0}
                    </Text>
                </View>
            </Pressable>
        </>
...
interface ReefscapeAutoModal {
    ...
    setFieldOrientation: Setter<Orientation>;
    selectedAlliance: string;
    setSelectedAlliance: Setter<Alliance>;
                            ...
                            if (lastAction) {
                                switch (lastAction.action) {
                                    ...
                                    case "reset":
                                        ...
                                        break;
                                    case ReefscapeActions[ReefscapeActionType.ScoreProcessor].link_name:
                                    case ReefscapeActions[ReefscapeActionType.MissProcessor].link_name:
                                    case ReefscapeActions[ReefscapeActionType.MissCoral].link_name:
                                    case ReefscapeActions[ReefscapeActionType.ScoreCoralL1].link_name:
                                    case ReefscapeActions[ReefscapeActionType.ScoreCoralL2].link_name:
                                    case ReefscapeActions[ReefscapeActionType.ScoreCoralL3].link_name:
                                    case ReefscapeActions[ReefscapeActionType.ScoreCoralL4].link_name:
                                        setArrayData((prevArrayData) => {
                    ...
                    {levelChooserActive ? (
                        <ReefscapeLevels
                            onSubmit={(level: ReefscapeActionType) => {
                                ...
                                setArrayData((prevArrayData) => {
                                    const linkItem = linkItemMap[ReefscapeActions[level].link_name];
                                    if (linkItem) {
                                        const { index } = linkItem;
                                        const newArrayData = [...prevArrayData];
                                        newArrayData[index] = prevArrayData[index] + 1;
                        ...
                        <>
                            <ReefscapeField
                                ...
                                onPieceIntake={(piece: number) => {
                                    ...
                                    setHistory((history) => [...history, { action: "intake", pieceID: piece }]);
                                }}
                                onPieceMissed={(piece: number) => {
                                    ...
                                    setHistory((history) => [...history, { action: "miss", pieceID: piece }]);
                                }}
                                onPieceReset={(piece: number) => {
                                    setAutoPath((paths) => paths.filter((path) => path.nodeId !== piece));
                                    setHistory((history) => [...history, { action: "reset", pieceID: piece }]);
                                }}
                                autoPath={autoPath}
                            />
                            <View
