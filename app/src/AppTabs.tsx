...
import { NavigatorScreenParams, ParamListBase, useNavigation, useTheme } from "@react-navigation/native";
...
function FilteringBottomTabBar(routes: string[]): (props: BottomTabBarProps) => React.ReactNode {
  return (props) => <BottomTabBar {...props} state={{...props.state, routes: props.state.routes.filter(x => {
    console.log(x)
