            ...
            <ScrollView>
                ...
                <ListItemContainer title={'Account'}>
                    <ListItem
                        ...
                        icon={() => <PenFill size="16" fill={getLighterColor(colors.primary)} />}
                    />
                    <ListItem
                        ...
                        caretVisible={true}
                        disabled={internetStatus !== InternetStatus.CONNECTED}
                        icon={() => <Asterisk size="16" fill={getLighterColor(colors.primary)} />}
                    />
                    <ListItem
                        ...
                        caretVisible={true}
                        disabled={internetStatus !== InternetStatus.CONNECTED}
                        icon={() => <Ban size="16" fill={getLighterColor(colors.primary)} />}
                    />
                    <ListItem
                        ...
                        caretVisible={false}
                        disabled={false}
                        icon={() => <QuestionCircle size="16" fill={getLighterColor(colors.primary)} />}
                    />
                    <ListItem
                        text={'Sign Out'}
                        ...
                        caretVisible={false}
                        disabled={false}
                        icon={() => <BoxArrowRight size="16" fill={getLighterColor(colors.primary)} />}
                    />
                </ListItemContainer>
                <ListItemContainer title={''}>
                    <ListItem
                        ...
                        caretVisible={true}
                        disabled={false}
                        icon={() => <JournalBookmarkFill size="16" fill={getLighterColor(colors.primary)} />}
                    />
                    <ListItem
                        ...
                        caretVisible={true}
                        disabled={false}
                        icon={() => <Sticky size="16" fill={getLighterColor(colors.primary)} />}
                    />
                </ListItemContainer>
                <SettingsPopup
