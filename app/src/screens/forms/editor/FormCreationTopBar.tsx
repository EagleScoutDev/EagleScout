...
import { FormNameModal } from "./FormNameModal.tsx";
...
export function FormCreationTopBar({ onSubmit, onCancel, questions }: FormCreationTopBarProps) {
    ...
    return (
        <>
            <FormNameModal visible={formNameModalVisible} setVisible={setFormNameModalVisible} onSubmit={onSubmit} />
            <View onPress={() => {}} style={styles.mainContainer}>
                ...
                <TouchableOpacity
                    onPress={() => {
                        if (questions.length === 0) {
                            Alert.alert("Error", "Please add at least one question to your form.");
