...
import AddCompetitionModal from './competitions-flow/AddCompetitionModal';
      ...
      {chosenComp !== null && (
        <View>
          ...
          <Text
            ...
            {new Date(chosenComp.start_time).toLocaleDateString('en-US', {
              month: 'short',
              day: 'numeric',
              // year: 'numeric',
            })}{' '}
            -{' '}
            {new Date(chosenComp.end_time).toLocaleDateString('en-US', {
              month: 'short',
              day: 'numeric',
            })}{' '}
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      ...
                      {new Date(tempComp.start_time).toLocaleDateString(
                        'en-US',
                        {
                          month: 'short',
                          day: 'numeric',
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      ...
                      {new Date(tempComp.end_time).toLocaleDateString('en-US', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric',
                      })}
