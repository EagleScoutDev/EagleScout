drop function if exists "public"."get_current_competition"();

drop function if exists "public"."list_all_competitions"();

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.get_competition_by_id(id integer)
